...
#ifndef _CLEAPROJINCLUDE_SHAPES_TRIANGLE_HPP
#define _CLEAPROJINCLUDE_SHAPES_TRIANGLE_HPP
...
class Triangle : public Element
{
  ...
  Triangle(const Triangle &sphere); 
  Triangle &operator=(const Triangle& sphere);
